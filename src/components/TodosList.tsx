...
export function TodosList() {
  ...
  const todos = useGlobalStore.useStore((state) => state.todos);
  const toggleTodoDone = useGlobalStore.useStore(
    (state) => state.toggleTodoDone,
  );
  const removeTodo = useGlobalStore.useStore((state) => state.removeTodo);
