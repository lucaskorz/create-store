...
export function UserMenu() {
  ...
  const user = useGlobalStore.useStore((state) => state.user);
  const login = useGlobalStore.useStore((state) => state.login);
  const logout = useGlobalStore.useStore((state) => state.logout);
